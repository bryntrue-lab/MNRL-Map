...
| Subtitle | `a practice for the creative psyche` |
...
| Element | String |
|---|---|
| Eyebrow | `WHERE YOU'RE BEGINNING` |
| Line | `in The Signal` |
...
1. Hello subtitle: `a companion for the creative psyche` → `a practice for the creative psyche` *(“companion” is reserved map vocabulary)*
