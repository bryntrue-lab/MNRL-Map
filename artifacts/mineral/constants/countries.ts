/**
 * Static ISO 3166-1 alpha-2 country list — Slice F1. No network, no
 * geocoding: deterministic enough to geocode server-side when Human
 * Design ships. English names, sorted.
 */
